...
@Component({
  templateUrl: './f01001wopen.component.html',
  styleUrls: ['./f01001wopen.component.css']
})
export class F01001wopenComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F01001wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f01001Service: F01001Service, public dialog: MatDialog) { }
  ...
  async getWalletId() {
    ...
    this.f01001Service.getWalletIdList('/consumer/f01001fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(F01001confirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
