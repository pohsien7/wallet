...
@Component({
  templateUrl: './f02010wopen.component.html',
  styleUrls: ['./f02010wopen.component.css']
})
export class F02010wopenComponent implements OnInit, AfterViewInit {
...
//============================================================
  ...
  async getWalletId() {
    ...
    this.f02010Service.getWalletIdList('/consumer/f02010fn01', jsonString).subscribe(data => {
