...
@Component({
  templateUrl: './f03012wopen.component.html',
  styleUrls: ['./f03012wopen.component.css']
})
export class F03012wopenComponent implements OnInit {
  ...
  walletOption: sysCode[] = [{value: 'INTERMEDIARIES_WALLET', viewValue: '中介機構錢包'}];

  constructor(public dialogRef: MatDialogRef<F03012wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe
    , private f03012Service: F03012Service, public dialog: MatDialog) { }
  ...
  async getWalletId() {
    ...
    this.f03012Service.getWalletIdList('/consumer/f03012fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(F03012confirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
