...
@Component({
  templateUrl: './f02013wopen.component.html',
  styleUrls: ['./f02013wopen.component.css']
})
export class F02013wopenComponent implements OnInit, AfterViewInit {
  ...
  walletOption: sysCode[] = [{value: 'J', viewValue: '記名錢包 (法人，憑證)'},
                             ...
                             {value: 'A', viewValue: '匿名錢包'}];

  constructor(public dialogRef: MatDialogRef<F02013wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f02005Service: F02013Service) { }
...
//============================================================
  ...
  async getWalletId() {
    ...
    this.f02005Service.getWalletIdList('/consumer/f02013fn01', jsonString).subscribe(data => {
