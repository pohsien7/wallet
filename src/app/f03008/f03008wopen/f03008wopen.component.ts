...
@Component({
  templateUrl: './f03008wopen.component.html',
  styleUrls: ['./f03008wopen.component.css']
})
export class F03008wopenComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F03008wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f03008Service: F03008Service, public dialog: MatDialog) { }
  ...
  async getWalletId() {
    ...
    this.f03008Service.getWalletIdList('/consumer/f03008fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(F03008confirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
