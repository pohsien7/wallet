...
@Component({
  templateUrl: './f02017wopen.component.html',
  styleUrls: ['./f02017wopen.component.css']
})
export class F02017wopenComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F02017wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f02017Service: F02017Service) { }
  ...
  async getWalletId() {
    ...
    this.f02017Service.getWalletIdList('/consumer/f02017fn01', jsonString).subscribe(data => {
