...
@Component({
  templateUrl: './f02021wopen.component.html',
  styleUrls: ['./f02021wopen.component.css']
})
export class F02021wopenComponent implements OnInit {
  ...
  walletOption: sysCode[] = [{value: 'JPWALLET_CERT', viewValue: '記名錢包 (法人，憑證)'},
                             ...
                             {value: 'INTERMEDIARIES_WALLET', viewValue: '中介機構錢包'}];

  constructor(public dialogRef: MatDialogRef<F02021wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f02021Service: F02021Service, public dialog: MatDialog) { }
  ...
  async getWalletId() {
    ...
    this.f02021Service.getWalletIdList('/consumer/f02021fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(F02021confirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
