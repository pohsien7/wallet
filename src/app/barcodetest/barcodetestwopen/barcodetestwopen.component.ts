...
import { BarcodetestService } from '../barcodetest.service';
...
@Component({
  templateUrl: './barcodetestwopen.component.html',
  styleUrls: ['./barcodetestwopen.component.css']
})
export class BarcodetestwopenComponent implements OnInit, AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<BarcodetestwopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private barcodetestService: BarcodetestService, public dialog: MatDialog) { }
...
//============================================================
  ...
  async getWalletId() {
    ...
    this.barcodetestService.getWalletIdList('/consumer/f03005fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(BarcodetestConfirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
