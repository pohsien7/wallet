...
@Component({
  templateUrl: './f03010wopen.component.html',
  styleUrls: ['./f03010wopen.component.css']
})
export class F03010wopenComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F03010wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f03010Service: F03010Service, public dialog: MatDialog) { }
  ...
  async getWalletId() {
    ...
    this.f03010Service.getWalletIdList('/consumer/f03010fn01', jsonString).subscribe(data => {
      this.totalCount = data.size;
      this.walletIdSource.data = data.items;
      if ( this.totalCount == 0 ) {
        this.dialog.open(F03010confirmComponent, { data: { msgStr: "查無錢包" } });
      }
    });
  }
