...
@Component({
  templateUrl: './f02008wopen.component.html',
  styleUrls: ['./f02008wopen.component.css']
})
export class F02008wopenComponent implements OnInit, AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<F02008wopenComponent>, private fb: FormBuilder, private datePipe: DatePipe, private f02005Service: F02008Service) { }
...
//============================================================
  ...
  async getWalletId() {
    ...
    this.f02005Service.getWalletIdList('/consumer/f02008fn01', jsonString).subscribe(data => {
