...
export class F01002wopenComponent implements OnInit {
  ...
  walletOption: sysCode[] = [{value: 'VAULT_TRANSFER', viewValue: 'Transfer'}, {value: 'issueCV', viewValue: 'IssueCV'}, {value: 'deduct', viewValue: 'Deduct'}, {value: 'redeem', viewValue: 'Redeem'}];
